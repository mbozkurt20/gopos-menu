...
<template>
  <div
    @click="go"
    class="table-card table-card--active"
    :class="tableDetailStore.willMoveTableId == table.id ? 'table-card--selected' : ''"
  >
    <div class="table-card__badge table-card__badge--active">Aktif</div>
...
.table-card--selected {
  box-shadow: 0 0 0 3px rgba(79, 70, 229, 0.4), 0 6px 20px rgba(79, 70, 229, 0.35);
  transform: translateY(-1px);
}
